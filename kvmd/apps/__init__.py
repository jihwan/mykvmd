...
from kvmd.plugins import UnknownPluginError
...
from kvmd.plugins.ugpio import BaseUserGpioDriver
from kvmd.plugins.ugpio import get_ugpio_driver_class

from kvmd.yamlconf import ConfigError
from kvmd.yamlconf import manual_validated
from kvmd.yamlconf import make_config
from kvmd.yamlconf import Section
from kvmd.yamlconf import Option
from kvmd.yamlconf import build_raw_from_options
from kvmd.yamlconf.dumper import make_config_dump
from kvmd.yamlconf.loader import load_yaml_file

from kvmd.validators.basic import valid_stripped_string
from kvmd.validators.basic import valid_stripped_string_not_empty
...
from kvmd.validators.os import valid_abs_file
from kvmd.validators.os import valid_abs_dir
from kvmd.validators.os import valid_unix_mode
from kvmd.validators.os import valid_options
    ...
    return {
        ...
        "kvmd": {
            ...
            "ocr": {
                ...
                "tessdata": Option("/usr/share/tessdata", type=valid_stripped_string_not_empty,
                                   unpack_as="data_dir_path")
            },
        ...
        "vnc": {
            ...
            "server": {
                ...
                "keepalive": {
                    ...
                    "idle": Option(10, type=functools.partial(valid_number, min=1, max=3600),
                                   unpack_as="keepalive_idle"),
                    "interval": Option(3, type=functools.partial(valid_number, min=1, max=60),
                                       unpack_as="keepalive_interval"),
                    "count": Option(3, type=functools.partial(valid_number, min=1, max=10),
                                    unpack_as="keepalive_count"),
                },
